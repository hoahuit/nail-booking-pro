...
const BUTTERFLIES = [
  {
    ...
    left: "6%",
    top: "18%",
    pathX: [0, 90, 40, 120, 20, 0],
    pathY: [0, -50, 30, -10, 50, 0],
  ...
  {
    color: "#f5c8c4",
    secondaryColor: "#e8b0b0",
    size: 52,
    left: "78%",
    top: "10%",
    pathX: [0, -60, -20, -90, -30, 0],
    pathY: [0, 40, -20, 60, -10, 0],
  ...
  {
    color: "#b8d8b0",
    secondaryColor: "#a0c898",
    size: 65,
    left: "55%",
    top: "72%",
    pathX: [0, -50, 30, -80, 10, 0],
    pathY: [0, -60, -20, -80, -30, 0],
  ...
  {
    color: "#e8d090",
    secondaryColor: "#d8b870",
    size: 42,
    left: "30%",
    top: "80%",
    pathX: [0, 70, 30, 90, 20, 0],
    pathY: [0, -40, -70, -30, -80, 0],
  ...
  {
    color: "#d8c8f0",
    secondaryColor: "#c8b8e0",
    size: 58,
    left: "88%",
    top: "55%",
    pathX: [0, -80, -40, -110, -20, 0],
    pathY: [0, 30, -40, 10, -60, 0],
  ...
  {
    color: "#f0c0c8",
    secondaryColor: "#e0a8b0",
    size: 46,
    left: "14%",
    top: "65%",
    pathX: [0, 40, 80, 20, 60, 0],
    pathY: [0, -50, -20, -70, -40, 0],
  ...
  {
    color: "#c8c4e8",
    secondaryColor: "#b8b0d8",
    size: 35,
    left: "48%",
    top: "8%",
    pathX: [0, 30, -20, 50, -10, 0],
    pathY: [0, 30, 60, 20, 50, 0],
  ...
  {
    color: "#e8c8a8",
    secondaryColor: "#d8b890",
    size: 38,
    left: "70%",
    top: "30%",
    pathX: [0, -30, 20, -50, 10, 0],
    pathY: [0, 40, -10, 50, 20, 0],
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.15) 60%, transparent 100%)",
        }}
      />
          ...
          >
            {stats.map((s) => (
              <div key={s.label}>
                ...
                <p className="mt-1.5 text-[10px] tracking-[0.2em] uppercase text-white/40">
                  {s.label}
                </p>
              </div>
            ))}
